...
Player.prototype.update = function (layer) {
    ...
    if (this.game.input.activePointer.isDown) {
        //  Boom!
        if (this.bullet.isFire()) this.bullet.fireToPointer(this.sprite.x, this.sprite.y); //this.bullet.fireToXY(this.sprite.x, this.sprite.y, this.level.game.input.activePointer.x, this.level.game.input.activePointer.y);
